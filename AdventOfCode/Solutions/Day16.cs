...
{
    // Украдено с https://github.com/encse/adventofcode/blob/master/2022/Day16/Solution.cs
    public class Day16
    {
        private const string FileUri = "./Inputs/day16.txt";

        public void Solution()
        {
            Console.WriteLine(PartOne(File.ReadAllText(FileUri)));
            Console.WriteLine(PartTwo(File.ReadAllText(FileUri)));
        }
